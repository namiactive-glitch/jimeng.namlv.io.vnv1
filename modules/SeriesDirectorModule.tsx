...
const SeriesDirectorModule: React.FC = () => {
  ...
  const handleDownloadAll = () => {
    ...
    let content = `PHIM BỘ: ${result.title}\n`;
    content += `TẬP: ${episodeNumber}\n`;
    ...
    a.href = url;
    a.download = `prompts-series-${result.title.substring(0, 20).replace(/\s+/g, '-')}-ep${episodeNumber}.txt`;
              ...
              <div className="flex flex-col sm:flex-row justify-between items-start gap-6 mb-8 md:mb-10">
                ...
                <div className="flex gap-2 md:gap-3 w-full sm:w-auto">
                  ...
                  <button 
                    ...
                    disabled={!result.scenes.some(s => s.finalPrompt)}
                    className="btn-secondary flex-1 sm:flex-none px-6"
                  >
