...
const CinematicPromptModule: React.FC = () => {
  ...
  const handleDownloadAll = () => {
    ...
    let content = `KỊCH BẢN: ${screenplay.overallPlot}\n\n`;
    ...
    a.href = url;
    a.download = `prompts-${screenplay.overallPlot.substring(0, 20).replace(/\s+/g, '-')}.txt`;
  ...
  return (
    <div className="w-full px-2 md:px-4 py-6 md:py-12">
      {/* Progress Stepper */}
      <div className="flex items-center justify-between mb-8 md:mb-16 w-full px-1 md:px-4">
        {[
              ...
              <div className="flex flex-col sm:flex-row justify-between items-start mb-8 md:mb-12 gap-6">
                ...
                <div className="flex flex-wrap gap-2 md:gap-3 w-full sm:w-auto">
                  ...
                  <button 
                    ...
                    disabled={!screenplay.episodes.some(e => e.scenes.some(s => s.finalPrompt))}
                    className="btn-secondary flex-1 sm:flex-none px-4 md:px-6"
                  >
            ...
            <div className="luxury-card relative overflow-hidden">
              ...
              <div className="flex justify-between items-start mb-12">
                ...
                <div className="flex gap-3">
                  <button 
                    onClick={handleDownloadAll}
                    className="p-3 hover:bg-white/10 rounded-2xl transition-colors border border-orange-100"
                    title="Tải tất cả prompt"
                  >
